    ...
    <Fragment>
      ...
      <div className="block_offset">
        ...
        <div className="text text_column">
          ...
          Дунавския регион. Резултатът от тази задача е пространствен модел на <Link to='/map'>Схема на
          национална мрежа от велосипедни маршрути</Link>, която фиксира международните
